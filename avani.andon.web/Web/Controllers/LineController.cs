...
namespace avSVAW.Controllers
{
    public class LineController : BaseController
    {
        ...
        public ActionResult Create()
        {
            ...
            model.IsAutos = new List<SelectListItem>();
            model.IsAutos.Add(new SelectListItem() { Value = "false", Text = "Thủ công" });
            model.IsAutos.Add(new SelectListItem() { Value = "true", Text = "Tự động" });
            return View(model);
        }
