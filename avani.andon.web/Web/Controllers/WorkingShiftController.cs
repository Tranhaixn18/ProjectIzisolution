...
namespace avSVAW.Controllers
{
    public class WorkingShiftController : BaseController
    {
        ...
        {
            List<tblShift> model = new WorkingShiftDao().listAll();
        ...
        {
            tblShift model = new tblShift();
            return View(model);
        }

        [HttpPost]
        public ActionResult Create(tblShift model)
        {
        ...
        {
            tblShift model = new WorkingShiftDao().ViewDetail(Id);
            return View(model);
        }


        [HttpPost]
        public ActionResult Edit(tblShift model)
        {
        ...
        {
            List<tblShift> lst = new WorkingShiftDao().listAll();
            return Json(lst);
        }
    }
}